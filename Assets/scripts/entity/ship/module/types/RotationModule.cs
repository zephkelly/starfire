...
namespace Starfire.Entity
{
    ...
    public struct ShipRotationData
    {
        public int ConfigId;
        ...
        public byte Mode; // Matches RotationMode enum
        public byte State; // Matches RotationState enum
        public byte IsEnabled;
    }

    public struct ShipRotationConfigData
    {
        public int ConfigId;
    ...
    public class ShipRotationModuleConfig : ScriptableObject
    {
        public int ConfigId;
        ...
        public ShipRotationConfigData ToBurstData()
        {
            return new ShipRotationConfigData
            {
                ConfigId = ConfigId,
                MaxHealth = MaxHealth,
                TurnRate = TurnRate
