...
{
    /// <summary>
    /// Manages the visual representation of the shield energy barrier.
    /// Generates mesh, applies shader, and tracks impact effects.
    /// </summary>
    ...
    public class ShieldVisual : MonoBehaviour
    {
        ...
        private void GenerateShieldMesh()
        {
            ...
            // Create vertices: center + edge vertices
        ...
        private void SetupMaterial()
        {
            ...
            // Set initial material properties from config
        ...
        {
            // Don't update visibility if shield is destroyed
        ...
        /// <summary>
        /// Register an impact at the given world position for ripple effect.
        /// </summary>
        ...
        {
            // Shield depleted - hide the visual immediately
        ...
        {
            // Shield recharged - restore visibility
            _isShieldDestroyed = false;
            UpdateInitialVisibility();
        }

        /// <summary>
        /// Manually refresh visual settings from config (for runtime changes).
        /// </summary>
