...
namespace Starfire
{
    public class PaladinCircleState : IState
    {
        ...
        public void Execute()
        {
            ...
            weightedDirection = _shipController.CircleTarget(weightedDirection, _pladinTransform.position, _paladinRigid2D.velocity, lastKnownPlayerPosition);
            ...
            bool isPlayerInSight = _shipController.IsTargetWithinSight(_pladinTransform.position, lastKnownPlayerPosition, targetSightDistance, targetSightAngle);
