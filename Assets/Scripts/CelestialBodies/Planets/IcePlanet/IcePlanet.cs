...
public class IceWorld : MonoBehaviour, ICelestialBody, IPlanet
{
  ...
  public void SetPlanetType(PlanetType type) => PlanetType = type;
    ...
    private void Awake()
    {
        m_PlanetUnder = PlanetUnder.GetComponent<SpriteRenderer>().material;
        m_Lakes = Lakes.GetComponent<SpriteRenderer>().material;
        m_Clouds = Clouds.GetComponent<SpriteRenderer>().material;
        SetInitialColors();
    }
