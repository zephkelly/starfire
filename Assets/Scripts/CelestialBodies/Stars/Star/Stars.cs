...
// namespace Starfire.CelestialGenerator
// {
  public class Stars : MonoBehaviour, ICelestialBody, IPlanet 
  {
    ...
    public PlanetType PlanetType { get; private set; } 
      ...
      private string[] init_colors1 = new string[] {"#77d6c1"};
    ...
    public void SetPlanetType(PlanetType type) => PlanetType = type;
      ...
      private void Awake()
      {
          m_Starbackground = StarBackground.GetComponent<SpriteRenderer>().material;
      ...
      public void SetInitialColors()
      {
          ...
          {
            m_Starbackground.SetColor(color_vars1[i], ColorUtil.FromRGB(color_vars1[i]));
          }
      }
