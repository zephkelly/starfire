...
namespace Starfire.Core.Background.Layers
{
    ...
    /// <summary>
    /// A stylized nebula layer with dramatic artistic effects including cosmic pillars,
    /// painterly posterization, wispy tendrils, and cellular/organic structures.
    /// </summary>
    [System.Serializable]
    public class StylizedNebulaLayer : StarfieldLayer
    {
        [Header("Preset")]
        [Tooltip("Optional preset to override all settings")]
        public StylizedNebulaLayerPreset preset;
        ...
        {
            return Shader.Find("Starfire/StylizedNebula");
        }
