...
{
    /// <summary>
    /// A layer that renders a procedural gas cloud using FBM noise with domain warping.
    /// Creates cloud-like gas cloud effects with gradient-based coloring.
    /// </summary>
    [System.Serializable]
    public class GasCloudLayer : StarfieldLayer
    {
        [Header("Preset")]
        [Tooltip("Optional preset to override all settings")]
        public GasCloudLayerPreset preset;
        ...
        {
            return Shader.Find("Starfire/GasCloud");
        }
