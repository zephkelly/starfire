...
{
    /// <summary>
    /// ScriptableObject preset for StylizedNebulaLayer configuration.
    /// Assign to a StylizedNebulaLayer to override all its settings.
    /// </summary>
    [CreateAssetMenu(fileName = "NewStylizedNebulaPreset", menuName = "Starfire/Presets/Stylized Nebula Preset")]
    public class StylizedNebulaLayerPreset : ScriptableObject
    {
        ...
        /// </summary>
        public void ApplyTo(StylizedNebulaLayer layer)
        {
