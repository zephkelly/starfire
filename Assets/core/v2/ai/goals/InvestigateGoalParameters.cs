...
namespace StarfireV2
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "StarfireV2/AI/Goals/Investigate Parameters")]
    public class InvestigateGoalParameters : GoalParameters
    {
        ...
        public V2DetectionLevel goalV2DetectionLevel = V2DetectionLevel.Silhouette;
        ...
        {
            context.Set(goalLevelKey, goalV2DetectionLevel);
