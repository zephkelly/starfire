...
namespace StarfireV2
{
    ...
    public class InitWaypointStackAction : BTAction
    {
        ...
        protected override BTNodeStatus OnExecute(float deltaTime)
        {
            ...
            Debug.LogWarning($"[InitWaypointStack] FAILURE: No waypoints found in blackboard. " +
                $"Checked keys: '{_transformsKey}' (transforms), '{_waypointsKey}' (static). " +
                $"Ensure waypoints are written to the blackboard via V2AISetup or PatrolGoal.Activate().");
