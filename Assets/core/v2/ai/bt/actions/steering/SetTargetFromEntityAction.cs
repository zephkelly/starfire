...
namespace StarfireV2
{
    ...
    /// Blackboard can store Transform, GameObject, or IEntityController.
    /// </summary>
    public class SetTargetFromEntityAction : BTAction
    {
        ...
        protected override BTNodeStatus OnExecute(float deltaTime)
        {
            ...
            // Try IEntityController
            else if (Context.TryGet<IEntityController>(_entityKey, out var controller))
            {
