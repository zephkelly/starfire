...
namespace StarfireV2
{
    ...
    {
        private readonly V2DetectionLevel _minDetectionLevel;
        private readonly int _maxResults;
        private readonly string _outputKey;
        private readonly string _excludeIdentifiedKey;

        public ScanForContactsAction(
            V2DetectionLevel minDetectionLevel = V2DetectionLevel.Presence,
            int maxResults = 10,
        ...
        protected override BTNodeStatus OnExecute(float deltaTime)
        {
            ...
            var contacts = sensor.GetEntitiesAtLevel(_minDetectionLevel)
                .Where(e => e.IsValid)
                .Where(e => identifiedIds == null || !identifiedIds.Contains(e.Transform.GetInstanceID()))
